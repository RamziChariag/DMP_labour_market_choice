...
!!$    write(*,*) 'REDUCED GRID FOR DEBUGGING'
    ...
    p%nFirms       =  9659.42866542628_wp   !50000;       ! Dummy number of firms
    p%nFirms_decentralized = 9659.42866542628_wp  ! number of firms from estiamtion
    p%rKost        = (0.05_wp/12.0_wp)*8935.21816539528_wp     ! flow cost (permanent) to increase number of firms
