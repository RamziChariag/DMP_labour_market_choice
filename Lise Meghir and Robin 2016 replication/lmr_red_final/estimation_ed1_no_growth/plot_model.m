...
% S_xy_planner = importdata('../planner_ed1/S_xy.dat');
...
% S1_xy = max(0,S_xy);
% colormap('hsv');
% lines = linspace(min(log(S1_xy(:))), max(log(S1_xy(:))), 25);
% h1 = contour(100*y,100*x, log(S1_xy), ([ 7.852 7.853 7.854 7.855 7.85575 7.8555 7.8575 7.859 7.87 7.89 7.93 lines]),  'LineWidth', 2 );set(gca,'FontSize', 16, 'FontName', 'times')
% axis square
% xlabel('Firm Type (Percentile)','FontSize',16, 'FontName', 'times');
% ylabel('Worker Type (Percentile)','FontSize',16, 'FontName', 'times');
% saveas(gcf, 'ed1_S_xy.eps', 'epsc2');


figure(200)
S1_xy = max(0,S_xy);
colormap('hsv');
lines = linspace(min(S1_xy(:)), max(S1_xy(:)), 25);
...
h2 = contourf(100*y,100*x, (h_xy/H), 'LineWidth', 2) ;
...
%% conditional CDFs
H_x_given_y = cumsum(h_xy,1);
H_y_given_x = cumsum(h_xy,2);

H_x_given_y = H_x_given_y ./ repmat(H_x_given_y(end,:),100,1 );

H_y_given_x = H_y_given_x ./ repmat(H_y_given_x(:,end),1,100 );

% figure(9)
% set(gca,'FontSize', 16, 'FontName', 'times')
% daspect([2 3 1]);
% plot1 = plot(100*y, H_y_given_x(1,:),  'LineWidth',3 );set(gca,'FontSize', 16, 'FontName', 'times');%, 100*y, H_y_given_x(20,:),  100*y, H_y_given_x(40,:),  100*y, H_y_given_x(60,:),  100*y, H_y_given_x(80,:),    100*y, H_y_given_x(X.m,:),  'LineWidth',3 );set(gca,'FontSize', 16, 'FontName', 'times')
...
% %daspect([2 300 1]);
% saveas(gcf, 'ed1_H_ycx.eps', 'epsc2');
% 
% figure(10)
% set(gca,'FontSize', 16, 'FontName', 'times')
% daspect([2 3 1]);
% plot1 = plot(100*x, H_x_given_y(:,1),  'LineWidth',3 );set(gca,'FontSize', 16, 'FontName', 'times'); %, 100*x, H_x_given_y(:,20),  100*x, H_x_given_y(:,40),  100*x, H_x_given_y(:,60),  100*x, H_x_given_y(:,80), 100*x, H_x_given_y(:,100),  'LineWidth',3 );set(gca,'FontSize', 16, 'FontName', 'times')
% %  set(plot1(1), 'LineStyle','-');
% %  set(plot1(2), 'LineStyle','--');
% %  set(plot1(3), 'LineStyle','.');
% %  set(plot1(4), 'LineStyle','-');
...
% %daspect([2 300 1]);
% saveas(gcf, 'ed1_H_xcy.eps', 'epsc2');

figure(9)
set(gca,'FontSize', 16, 'FontName', 'times')
daspect([2 3 1]);
plot1 = plot(100*y, H_y_given_x(1,:), 100*y, H_y_given_x(20,:),  100*y, H_y_given_x(40,:),  100*y, H_y_given_x(60,:),  100*y, H_y_given_x(80,:),    100*y, H_y_given_x(X.m,:),  'LineWidth',3 );set(gca,'FontSize', 16, 'FontName', 'times')
  set(plot1(1), 'LineStyle','-');
  set(plot1(2), 'LineStyle','--');
  set(plot1(3), 'LineStyle','.');
  set(plot1(4), 'LineStyle','-');
...
set(gca,'FontSize', 16, 'FontName', 'times')
daspect([2 3 1]);
plot1 = plot(100*x, H_x_given_y(:,1), 100*x, H_x_given_y(:,20),  100*x, H_x_given_y(:,40),  100*x, H_x_given_y(:,60),  100*x, H_x_given_y(:,80), 100*x, H_x_given_y(:,100),  'LineWidth',3 );set(gca,'FontSize', 16, 'FontName', 'times')
  set(plot1(1), 'LineStyle','-');
  set(plot1(2), 'LineStyle','--');
  set(plot1(3), 'LineStyle','.');
  set(plot1(4), 'LineStyle','-');
...
% saveas(gcf, 'ed1_q_xcy.eps', 'epsc2');
% 
% figure(201)
...
% saveas(gcf, 'ed1_q_ycx.eps', 'epsc2');
% 
...
saveas(gcf, 'ed1_M_xy_v2.eps', 'epsc2');
...
xlabel('Firm Type','FontSize',16, 'FontName', 'times');
ylabel('Worker Type','FontSize',16, 'FontName', 'times');
saveas(gcf, 'ed1_h_xy_v2.eps', 'epsc2');
