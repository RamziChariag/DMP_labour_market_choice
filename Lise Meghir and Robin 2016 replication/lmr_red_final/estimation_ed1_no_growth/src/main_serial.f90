...
!  call printVec(theta_rescaled)
  ...
  if (base_switch) then
     ...
     !call readFromCSV('data/COV_shrink_ed2.raw', GLOBAL_TRUE_COV_MATRIX)
     ...
     !call readFromCSVvec('data/mom_ed2.raw'  , GLOBAL_TRUE_MOMENT_MATRIX)
     !call readFromCSVvec('data/se_ed2.raw'   , GLOBAL_TRUE_SD_MATRIX)
     ! call readFromCSV('data/n_ed2_v1.raw' , GLOBAL_TRUE_N_MATRIX)
