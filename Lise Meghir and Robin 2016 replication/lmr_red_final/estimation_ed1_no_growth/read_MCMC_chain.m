...
alpha_ = exp(alpha(end-6500:end,:));
s1_    = exp(s1(end-6500:end,:));
zeta_   =  0.1*exp(zeta(end-6500:end,:))./(exp(zeta(end-6500:end,:))+exp(-zeta(end-6500:end,:)));
beta_   = exp(beta(end-6500:end,:))./(exp(beta(end-6500:end,:))+exp(-beta(end-6500:end,:)));
f1_     = exp(f1(end-6500:end,:));
f2_     = exp(f2(end-6500:end,:))./(exp(f2(end-6500:end,:))+exp(-f2(end-6500:end,:))); 
f3_     = 1 - exp(f3(end-6500:end,:));
f4_     = exp(f4(end-6500:end,:));
f5_     = exp(f5(end-6500:end,:));
f6_     = exp(f6(end-6500:end,:));
f7_     = exp(f7(end-6500:end,:));
delta_  = 0.5*exp(delta(end-6500:end,:))./(exp(delta(end-6500:end,:))+exp(-delta(end-6500:end,:))) ;
sigma_  = exp(sigma(end-6500:end,:));
b_      = exp(b(end-6500:end,:))./(exp(b(end-6500:end,:))+exp(-b(end-6500:end,:)));
c_      = exp(c(end-6500:end,:));
