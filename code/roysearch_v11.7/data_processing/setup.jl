...
#
# overlap_UgtS, overlap_SltU, ltu_share_S (cross-market wage-overlap
# pair + skilled long-term-unemployment share) and the within-job
# wage-change pair wchg_rate_U / wchg_rate_S (SIPP) and the skilled EE-move
# wage step ee_step_S (SIPP; identifies β_S) are appended at the END so the
# legacy moment indices and Σ̂ columns are unchanged.
# ============================================================
const MOMENT_NAMES = [
    :ur_total, :ur_U, :ur_S,
