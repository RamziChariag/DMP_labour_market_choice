...
function print_spec(spec::SMMSpec;
    ...
    # The rate rule is what actually stops NM: f_tol and x_tol are unread by Optim's
    # Nelder-Mead and g_tol is unreachable at this scale, so this is the operative line.
