...
#
#   ROYSEARCH_WINDOW=base_fc julia --project=. -t 8 code/tools/rank_diagnostic.jl
#
...
@isdefined(ROYSEARCH_PATHS_LOADED) || include(joinpath(R, "code", "paths.jl"))
...
bundle = deserialize(estimate_path(WINDOW, W_SUFFIX))
spec   = bundle.spec
