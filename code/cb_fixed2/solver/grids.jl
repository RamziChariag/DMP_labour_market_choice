...
#
#   π̄_U ≡ E[π_U(x,p)] = exp(A) · P_U · E_ℓ[x]      · E_G[p],  E_G[p] = α_U/(α_U+1)
#   π̄_S ≡ E[π_S(x,p)] = exp(A) · γ_PS · E_ℓ[x^γ_PS] · E_Γ[p],  E_Γ[p] = a_Γ/(a_Γ+b_Γ)
#
