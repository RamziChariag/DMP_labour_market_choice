...
# rather than a stop.  Preserving that distinction is why run_smm checks the span
# in short sub-windows rather than as one long one — see its docstring.
#
