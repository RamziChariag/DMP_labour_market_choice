...
function clean_cps_basic()
    ...
    # concept (excludes the training mass agg_t), keeping the industry
    # skill shares used by the JOLTS allocation aligned with the
    # skilled_share moment in Stage 7.
