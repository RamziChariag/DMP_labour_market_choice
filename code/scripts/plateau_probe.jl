...
#
#   RSROOT=<repo> julia --project=. -t <threads> code/scripts/plateau_probe.jl
#
...
const BPATH = joinpath(ROOT, "output", "smm", "smm_result_$(WINDOW)$(W_SUFFIX).jls")
...
out = joinpath(ROOT, "output", "smm", "plateau_probe_$(WINDOW)$(W_SUFFIX).csv")
