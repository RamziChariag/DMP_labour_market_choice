...
#      and save  output/transition_fct_ps/transition_<sc><W>_fct_ps.jld2
...
#
# Sub-scripts:
#   transition_simulation_fct_ps.jl   — defines run_transition_simulation(...)
#   transition_panel_fct_ps.jl        — defines make_transition_panel(...) and
#                                       make_model_decomposition_panel(...)
#   plots_and_tables_fct_ps.jl        — defines load_all_smm_bundles!(),
...
#   false → use the existing transition_<scenario><W>_fct_ps.jld2 if it is
...
include(joinpath(TRANSITION_DIR, "transition_simulation_fct_ps.jl"))
include(joinpath(TRANSITION_DIR, "transition_panel_fct_ps.jl"))
include(joinpath(TRANSITION_DIR, "plots_and_tables_fct_ps.jl"))
println("done."); flush(stdout)
...
for scenario in SCENARIOS
    out_file = joinpath(TRANS_OUT_DIR,
                        "transition_$(scenario)$(W_SUFFIX)_fct_ps.jld2")
