...
#   julia code/transition_fct_ps/plots_and_tables.jl
...
SOLVER_DIR   = joinpath(PROJECT_ROOT, "code", "solver_fct_ps")
SMM_SRC_DIR  = joinpath(PROJECT_ROOT, "code", "smm_fct_ps")
...
TRANS_DIR    = joinpath(OUTPUT_DIR, "transition_fct_ps")
...
for w in ALL_WINDOWS
    jls_path = joinpath(SMM_OUT_DIR, "smm_result_$(w)$(W_SUFFIX)_fct_ps.jls")
    if isfile(jls_path)
