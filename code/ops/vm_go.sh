#!/usr/bin/env bash
# ON THE LAPTOP, from the repo:  bash code/ops/vm_go.sh base_covid
...
tmux new -d -s roysearch \"cd ~/DMP_labour_market_choice && ROYSEARCH_WINDOW=${W} bash code/ops/vm_run.sh\"
sleep 5; tmux ls
"
sleep 3
