...
function default_free_params() :: Vector{ParamSpec}
    return [
        ...
        ParamSpec(:common, :c,   0.01,  4.00,  1.70,  "training cost coeff c"),
        ...
        # ── UnskilledParams ────────────────────────────────────────────
        ParamSpec(:unsk, :μ,    0.10,  3.00,  0.74,  "unskilled matching eff μ_U"),
        ...
        # ── SkilledParams ──────────────────────────────────────────────
        ParamSpec(:skl, :μ,    0.10,  3.00,  0.90,  "skilled matching eff μ_S"),
        ...
        ParamSpec(:skl, :ξ,    0.001, 0.25,  0.03,  "skilled exog. sep rate ξ"),
