...
# wage-change pair wchg_rate_U / wchg_rate_S (SIPP) are appended at the
# END so the legacy moment indices and Σ̂ columns are unchanged.
# ============================================================
const MOMENT_NAMES = [
    :ur_total, :ur_U, :ur_S,
